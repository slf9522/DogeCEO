...
class _Config:
    ...
    BBS_SIGN_IN = 'https://bbs-api.mihoyo.com/apihub/sapi/signIn?gids=2'
    BBS_POST_LIST = "https://bbs-api.mihoyo.com/post/api/getForumPostList?forum_id=26&is_good=false&is_hot=false&page_size=5&sort_type=1"
    BBS_SINGLE_POST = "https://bbs-api.mihoyo.com/post/api/getPostFull?post_id={}"
    BBS_VOTE = "https://bbs-api.mihoyo.com/apihub/sapi/upvotePost"
...
MESSAGE_BBS_TEMPLATE = '''
    {today:#^28}
    🔅[{region_name}]{uid}
    浏览帖子: {bbs_status}
    点赞帖子: {bbs_post_status} 
    {end:#^28}'''
